    ...
    <div class="container">
      ...
      <div class="elenco">
        ...
        <div class="voce_elenco">
          ...
          <h2 class="domanda segno" data-switch="close" onclick="expand(this,'data-switch')">&nbsp;Corso di italiano</h2>

          <div class="risposta"><?php include "include/alta-formazione/Corso-di-italiano.php"; ?></div>

        </div>

        <div class="voce_elenco">

          <h2 class="domanda segno" data-switch="close" onclick="expand(this,'data-switch')">&nbsp;Lingue</h2>

          <div class="risposta"><?php include "include/alta-formazione/Lingue.php"; ?></div>
