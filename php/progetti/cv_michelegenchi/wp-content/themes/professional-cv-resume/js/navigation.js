// Menu Functions
function professional_cv_resume_openNav() {
	jQuery(".sidenav").addClass('show');
  }
  
  function professional_cv_resume_closeNav() {
	jQuery(".sidenav").removeClass('show');
  }
  
  /////////////////////// Focus handling ///////////////////////
  (function(window, document) {
	function professional_cv_resume_handleMobileMenuNavigation() {
	...
	document.addEventListener('DOMContentLoaded', function() {
	  professional_cv_resume_handleMobileMenuNavigation();
