...
if ( ! class_exists( 'Professional_CV_Resume_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Professional_CV_Resume_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Professional_CV_Resume_WPTT_WebFont_Loader( $url );
